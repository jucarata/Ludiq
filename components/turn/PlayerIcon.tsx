...
export function PlayerIcon({
  ...
  return (
    ...
    >
      ...
      <span
        className="pointer-events-none absolute bottom-0 left-1/2 z-10 max-w-[4.5rem] -translate-x-1/2 translate-y-[35%] truncate rounded-sm bg-[#1a1a2e] px-1.5 py-0.5 text-center text-[8px] font-bold uppercase leading-none tracking-wide text-[#fefae0] shadow-md sm:max-w-[5.25rem] sm:text-[9px] md:max-w-[5.75rem] md:text-[10px]"
        style={{
          boxShadow: isActive
