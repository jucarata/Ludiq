export const en = {
  ...
  room: {
    ...
    depositError: "Could not deposit entry fee. Check USDC and gas on Celo Sepolia.",
    depositWalletRequired: "Link a wallet to your profile to play competitive.",
    depositWalletMismatch:
      "Unlock MetaMask (or your browser wallet) with {wallet} on Celo Sepolia and try again.",
