export const en = {
  ...
  shop: {
    ...
    offerAria: "Buy {amount} Koins for {price} USDT",
    confirmTitle: "Confirm purchase",
    confirmBody: "You're about to buy {amount} Koins for {price} USDT.",
    confirm: "Confirm",
    cancel: "Cancel",
    paying: "Paying…",
    confirming: "Confirming…",
    loading: "Loading offers…",
    purchaseSuccess: "+{amount} Koins added to your balance!",
    errorLoad: "Could not load shop offers",
    errorSession: "Could not get session.",
    errorWalletRequired: "Link a wallet in your profile to buy Koins.",
    errorBuy: "Purchase failed. Check USDT balance and try again.",
    errorConfirm: "Payment went through but we could not credit Koins. Contact support with your tx.",
  },
  tutorial: {
  ...
  turn: {
    ...
    autoMode: "Auto mode",
    autoFor: "Auto — {label}",
    rerollHint: "Reroll dice ({cost} Koins)",
    rerollAria: "Reroll dice for {cost} Koins",
    rerollInsufficient: "You need {cost} Koins to reroll.",
    rerollAuth: "Sign in and create a profile to reroll.",
    rerollError: "Could not reroll. Try again.",
