...
export const es: Messages = {
  ...
  shop: {
    title: "Tienda",
    buyKoins: "Comprar Koins",
    yourBalance: "{amount} Koins",
    offerAmount: "x{amount}",
    offerPrice: "{price} USDT",
    offerAria: "Comprar {amount} Koins por {price} USDT",
    confirmTitle: "Confirmar compra",
    confirmBody: "Vas a comprar {amount} Koins por {price} USDT.",
    confirm: "Confirmar",
    cancel: "Cancelar",
    paying: "Pagando…",
    confirming: "Confirmando…",
    loading: "Cargando ofertas…",
    purchaseSuccess: "¡+{amount} Koins añadidos a tu balance!",
    errorLoad: "No se pudieron cargar las ofertas",
    errorSession: "No se pudo obtener la sesión.",
    errorWalletRequired:
      "Vincula una billetera en tu perfil para comprar Koins.",
    errorBuy: "La compra falló. Revisa tu USDT e inténtalo de nuevo.",
    errorConfirm:
      "El pago se hizo pero no pudimos acreditar los Koins. Contacta soporte con tu tx.",
  },
  tutorial: {
  ...
  turn: {
    ...
    autoMode: "Modo auto",
    autoFor: "Auto — {label}",
    rerollHint: "Relanzar dados ({cost} Koins)",
    rerollAria: "Relanzar dados por {cost} Koins",
    rerollInsufficient: "Necesitas {cost} Koins para relanzar.",
    rerollAuth: "Inicia sesión y crea un perfil para relanzar.",
    rerollError: "No se pudo relanzar. Inténtalo de nuevo.",
