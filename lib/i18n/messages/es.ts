...
export const es: Messages = {
  ...
  room: {
    ...
    potLabel: "Bote",
    potAmountPending: "— USDC",
    potAmount: "{amount} USDC",
    depositing: "Los dados están rodando…",
    depositingHint: "Si tu wallet pide confirmación, acéptala",
    depositError: "No se pudo depositar la entrada. Revisa USDC y gas en Celo Sepolia.",
    depositWalletRequired: "Vincula una wallet a tu perfil para jugar competitivo.",
    depositWalletMismatch:
      "Desbloquea MetaMask (u otra wallet) con {wallet} en Celo Sepolia e inténtalo de nuevo.",
